...
const ProjectCard = ({
  ...
  const fetchComments = async () => {
    try {
      const response = await fetch(
        `https://vuibackend-6-0.onrender.com/api/review/project/${id}`,
        {
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${token}`,
  ...
  const addComment = async () => {
    ...
    try {
      const response = await fetch("https://vuibackend-6-0.onrender.com/api/review", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const deleteComment = async (commentId) => {
    try {
      const token = sessionStorage.getItem("token");
      const response = await fetch(
        `https://vuibackend-6-0.onrender.com/api/review/${commentId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const updateComment = async () => {
    try {
      const token = sessionStorage.getItem("token");
      const response = await fetch(
        `https://vuibackend-6-0.onrender.com/api/review/${editCommentId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
...
const Projects = () => {
  ...
  const fetchProjects = async () => {
    let url = "https://vuibackend-6-0.onrender.com/api/project";

    if (selectedStatus.length && !selectedStatus.includes("All")) {
      url = `https://vuibackend-6-0.onrender.com/api/project/status/${selectedStatus.join(
        ","
      )}`;
    }
  ...
  const fetchProjectsByTitle = async () => {
    ...
    try {
      const url = `https://vuibackend-6-0.onrender.com/api/project/title/${searchTerm}`;
      const response = await fetch(url);
      const data = await response.json();
